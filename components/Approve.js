...
export function ApproveToken(weiAmount) {
  ...
  const result2 = useReadContract({
    ...
    args: [
      ...
      "0xf3100FbB3BD5a6802eC9f15Eaf115E95F1116F87", // "0x9A9bc340103C462365Db54E423f95784C664d3Df", // KCP bridge contract address 0x9A9bc340103C462365Db54E423f95784C664d3Df
    ],
  });
  result2.data;
  ...
  const result = useReadContract({
    ...
    args: [
      address, // "0x2373a942FEbC0ee428b266bDD58275794E7f1553", // user address
      "0xf3100FbB3BD5a6802eC9f15Eaf115E95F1116F87", // "0xC5052054DBDC35f84D279CB321bE98480d807f6F", //BSC  bridge contract address
    ],
  });
  result.data;
  ...
  const handleApprove2 = async () => {
    try {
      ...
      await writeContract({
        ...
        functionName: "approve",
        args: [
          "0xf3100FbB3BD5a6802eC9f15Eaf115E95F1116F87", // BSC contract address
